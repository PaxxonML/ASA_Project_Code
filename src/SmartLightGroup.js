...
class SmartLightGroup extends Observable{
    constructor(house, person, room, lightGroupName, noOfLights) {
        super()
        this.house = house;
        ...
        for ( let i = 1; i <= noOfLights; i++ ) {
            this.lights.push(new SmartLight(this.house, person, room, cutName.concat(i.toString())))
        }
    }
...
module.exports = SmartLightGroup